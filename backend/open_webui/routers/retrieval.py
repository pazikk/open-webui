...
async def get_rag_config(request: Request, user=Depends(get_admin_user)):
    return {
        ...
        "content_extraction": {
            ...
            "marker_pdf_server_url": request.app.state.config.MARKER_PDF_SERVER_URL,
        },
        "chunk": {
...
class ContentExtractionConfig(BaseModel):
    ...
    marker_pdf_server_url: Optional[str] = None
...
async def update_rag_config(
    ...
    if form_data.content_extraction is not None:
        ...
        request.app.state.config.MARKER_PDF_SERVER_URL = (
            form_data.content_extraction.marker_pdf_server_url
        )
